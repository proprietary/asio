...
template <typename T, typename... Vs>
ASIO_CONSTEXPR const bool is_receiver_of_v = is_receiver<T, Vs...>::value;
...
#define ASIO_EXECUTION_RECEIVER_OF ::asio::execution::receiver_of
...
ASIO_CONSTEXPR const bool is_nothrow_receiver_of_v =
  is_nothrow_receiver<T, Vs...>::value;
